;console.log('Holly ');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('mb')<0){}};
/*
...
;console.log('源代码唯一下载地址: Holly');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('mb')<0){}};